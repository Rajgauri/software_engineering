							...
							<tr align="center">
								...
								<td><?php global $con;
										if(isset($_POST['update_cart'])){
											...
											$_SESSION['qty'] = $qty;
											// if (isset($_POST['remove']) AND $_POST['remove']==$p_price['cart_id'])
											// {
											// $delete_cart = "delete from cart where cart_id = '$cart_id'";
											// $run_qty = mysqli_query($con, $delete_cart);	
											// $total = $total - ($p_price['qty'])*$pp_price['product_price'];
											// }
											// else	
											// $total = $total - ($p_price['qty'] - $qty)*$pp_price['product_price'];
